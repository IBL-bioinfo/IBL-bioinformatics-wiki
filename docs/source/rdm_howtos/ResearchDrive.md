...
- Users install the Nextcloud desktop client from the company portal (Windows 11) or Managed Software Center (MacOS), and log in to Research Drive with their ULCN account. See the next section for details.
